...
def combined_tracker_UI(os_url, kibana_url, default_url, frequency, user_secret, created_By, created_on, volume, service, most_recent_run, current_state, latest_toc_handle_processed, gdac_scheduler_name):
    """
    tracker_UI: Going to create the dynamic json file
    """ 
    integration_name = volume + "_" + service
    tracker_json_filename = gdac_scheduler_name + "_tracker_ES.json"
...
if __name__ == '__main__':
    ...
    gdac_scheduler_name = sys.argv[13]
    print("Tracker Json ::: Execution Started")
    tracker_json = combined_tracker_UI(os_url, kibana_url, default_url, frequency, user_secret, created_By, created_on, volume, service, most_recent_run, current_state, latest_toc_handle_processed, gdac_scheduler_name)
